// App shell v46: show live traffic signals without requiring route selection.
const CACHE_NAME='bus-map-shell-v46-20260925-browse-signals';
...
const PAGE_PATCH='<script src="./request-guard.js?v=46"></script><script src="./mobile-patch.js?v=46"></script><script src="./gapless-patch.js?v=46"></script><script src="./traffic-map-patch.js?v=46"></script><script src="./ios-touch-patch.js?v=46"></script>';
async function patchedHtmlResponse(response){
 ...
 if(!text.includes('gapless-patch.js?v=46'))text=/<\/body>/i.test(text)?text.replace(/<\/body>/i,PAGE_PATCH+'</body>'):text+PAGE_PATCH;
