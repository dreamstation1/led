// App shell v47: hide noisy Gyeonggi stops by default and expose a filtered visibility toggle.
const CACHE_NAME='bus-map-shell-v47-20260925-gyeonggi-stop-filter';
...
const PAGE_PATCH='<script src="./request-guard.js?v=47"></script><script src="./mobile-patch.js?v=47"></script><script src="./gapless-patch.js?v=47"></script><script src="./traffic-map-patch.js?v=47"></script><script src="./ios-touch-patch.js?v=47"></script><script src="./gyeonggi-stops-patch.js?v=47"></script>';
